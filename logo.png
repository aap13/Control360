...
if (request_is_post()) {
    ...
    if (empty($erros)) {
        try {
            ...
            $ignoredStatuses = ['desinstalada', 'inativa', 'recolhida', 'backup'];
            ...
            <div class="form-grid">
                ...
                <div class="form-group full">
                    ...
                    <small style="display:block;margin-top:8px;color:var(--muted)">
                        Regras aplicadas: leitura do mês atual = <strong>Online</strong>; leitura fora do mês atual = <strong>Offline</strong>; equipamento ausente no CSV = <strong>Offline</strong>; equipamentos <strong>desinstalados/inativos/recolhidos/backup</strong> são ignorados.
                    </small>
                </div>
            </div>
