...
<div class="page-head">
    <div class="page-head-copy">
        ...
        <p>Acompanhe lançamentos e compare o comportamento dos pagamentos ao longo do ano em uma visualização mais limpa.</p>
    </div>
    ...
    <div class="card faturas-side-card">
        <div class="faturas-side-top">
            <div>
                ...
                <p class="faturas-side-copy">O valor anual saiu do topo e ficou separado do botão para a leitura ficar mais organizada.</p>
            </div>
