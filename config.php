...
function setupAtivosHistoricoDB() {
    $pdo = getDB();
    $pdo->exec("
        CREATE TABLE IF NOT EXISTS ativos_historico (
            ...
            INDEX idx_ativo (ativo_tipo, ativo_id, criado_em),
            INDEX idx_chamado (chamado_id)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
    ");
}
setupAtivosHistoricoDB();
...
function setupDistribuicaoDB() {
    ...
    ");
    ensure_column_exists($pdo, 'distribuicao_clientes', 'modelo_cobranca', "VARCHAR(30) NOT NULL DEFAULT 'sem_franquia' AFTER cnpj");
    ...
    $pdo->exec("
        CREATE TABLE IF NOT EXISTS usuarios_clientes (
            ...
            pode_editar TINYINT(1) NOT NULL DEFAULT 0,
            pode_importar TINYINT(1) NOT NULL DEFAULT 0,
            UNIQUE KEY uk_usuario_cliente (usuario_id, cliente_id),
            INDEX idx_uc_cliente (cliente_id)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
    ");

    $pdo->exec("
        CREATE TABLE IF NOT EXISTS usuarios_clientes_empresas (
            id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
            usuario_id INT UNSIGNED NOT NULL,
            cliente_id INT UNSIGNED NOT NULL,
            ...
            pode_editar TINYINT(1) NOT NULL DEFAULT 0,
            pode_importar TINYINT(1) NOT NULL DEFAULT 0,
            UNIQUE KEY uk_usuario_cliente_empresa (usuario_id, cliente_id, empresa),
            INDEX idx_uce_cliente (cliente_id),
            INDEX idx_uce_empresa (empresa)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
    ");
