...
<aside class="sidebar" id="sidebar">
  ...
  <div class="sidebar-scroll">
    ...
    <div class="nav-section">
      ...
      <div class="nav-stack">
        <a href="distribuicao_index.php" class="nav-link <?= in_array($page,['distribuicao_index.php','distribuicao_cadastrar.php','distribuicao_editar.php','distribuicao_troca_tecnica.php','distribuicao_movimentacoes.php','distribuicao_importar_monitoramento.php'], true)?'active':'' ?>">
  ...
  <div class="sidebar-footer">
    <a href="perfil.php" class="sidebar-user-card">
      ...
      <div style="display:flex;align-items:center;gap:12px;min-width:0">
        ...
        <div class="topbar-title">
          <span class="topbar-title-icon"><?php
              ...
              elseif ($page === 'faturas.php') echo icon('bill');
